...
final class Scheduler {
	...
	public function describe(): array {
		return array(
			'available' => false,
			'title'     => __( 'Scheduled Scans and Alerts', 'daiosity-conflict-debugger' ),
			'message'   => __( 'Planned for premium. The architecture already reserves a cron hook for future scheduled scans and notifications.', 'daiosity-conflict-debugger' ),
		);
	}
}
